...
| Login responsive UI | `/login` | Public | Inputs, disabled submit, mobile/desktop overflow, console errors | Usable at desktop/mobile with no console/page errors | Confirmed on staging at Desktop Chrome and Pixel 5 viewports | `test:e2e:public`, `test:auth-mobile` | PASS |
