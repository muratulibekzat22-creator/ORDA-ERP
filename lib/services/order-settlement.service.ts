...
export type SettlementSource = { amount: Money; partnerId?: number | null; partnerPrice: Money; partnerAgreedAt?: Date | string | null; partner?: { id: number; name: string } | null; payments?: Payment[]; partnerAssignmentHistory?: Assignment[]; status?: string };
