...
export const documentTypeLabels: Record<DocumentType, string> = {
  ...
  PREPAYMENT_CONFIRMATION: "Подтверждение предоплаты (архив)",
  CLOSING_ACT: "Закрывающий акт (архив)",
  WARRANTY: "Гарантия (архив)",
  FINAL_PAYMENT_CONFIRMATION: "Подтверждение окончательной оплаты (архив)",
  ESTIMATE: "Смета",
  PROJECT: "Проект",
