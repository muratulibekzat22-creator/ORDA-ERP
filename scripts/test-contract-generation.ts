...
const base: ContractSnapshot = {
  contractNumber: "ДОГ-000001", orderNumber: "ORD-000001", contractDateIso: "2026-08-09T07:00:00.000Z", contractTime: "12:00", contractDay: "09", contractMonth: "августа", contractYear: "2026", contractCity: "Алматы",
  clientFullName: "Иванов Иван Иванович", clientIin: "990101300001", clientPhone: "+7 700 000 00 00", clientAddress: "Алматы", clientCity: "Алматы", installationAddress: "Алматы, Абая 1", stairMaterial: "Сосна", frameType: "Металл", frameComment: "", balusterType: "Классика", supportType: "Стандарт", color: "Орех", lightingText: "Нет", claddingText: "Нет", deliveryText: "Включена", installationText: "Включён", additionalDetails: "Нет",
  ...
  balancePercent: "30", balanceAmount: "300 000", balanceAmountWords: "триста тысяч", balanceAmountNumeric: 300_000, isFullPayment: false, paymentSchedulePrimary: "70% — 700 000 ₸", paymentScheduleBalance: "30% — 300 000 ₸", prepaymentDueText: "в день подписания настоящего Договора", balanceDueText: "после завершения монтажа", fullPaymentDueText: "в день подписания настоящего Договора",
...
assert.equal((splitXml.match(/<w:tbl>/g) ?? []).length, 4, "contract package table structure changed");
...
assert.equal((fullXml.match(/<w:tbl>/g) ?? []).length, 4, "100% contract table structure changed");
