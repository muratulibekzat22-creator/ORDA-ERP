...
process.env.NEXTAUTH_SECRET ||= "local-finance-go-live-test-secret";
...
const steps: Array<{
  ...
  },
  {
    label: "Payroll",
    command: npm,
    args: ["run", "test:payroll"],
    timeout: 300_000,
  },
  {
    label: "Finance journal",
    command: npm,
    args: ["run", "test:finance-journal"],
    timeout: 180_000,
  },
  {
...
console.log("\nAll finance go-live checks passed on TEST_DATABASE_URL");
