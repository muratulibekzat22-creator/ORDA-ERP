...
const relations: Array<[child: string, foreignKey: string, parent: string]> = [
  ...
  ["BankStatementTransaction", "suggestedOrderId", "Order"],
  ...
  ["BankStatementTransaction", "importId", "BankStatementImport"],
  ["BankStatementTransaction", "suggestedClientId", "Client"],
  ["BankStatementTransaction", "postedPaymentId", "Payment"],
  ["BankStatementTransaction", "postedLedgerEntryId", "CompanyLedgerEntry"],
  ["BankStatementImport", "createdById", "User"],
  ["BankStatementRule", "clientId", "Client"],
  ["BankStatementRule", "updatedById", "User"],
